<template>
  <div class="">
    ...
    <!--添加一个fold展示时候上面背景模糊，然后给他加一个点击事件隐藏fold-->
...
<script>
//  在这里引用cartcontrol是复用了他的显示模块在商品详情这一栏
...
//    下面的代码不会报错，但是功能不完全，因为没有加载BScroll，导致在购物车里点击事件无效
//      listShow () {
//        if (!this.totalCount) {
//          return false;
//        }
